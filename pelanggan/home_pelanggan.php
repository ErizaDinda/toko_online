    ...
    <section class="py-5 text-center container">
        <div class="col-lg-6 col-md-8 mx-auto">
            ...
            <form method="POST" action="home_pelanggan.php" class="d-flex">
                    ...
                    placeholder="Search" aria-label="Search" style="background-color: #FF87CA">
          ...
          <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    <a href="produk.php?id_buku=<?=$data_produk['id_produk']?>" type="button" class="btn text-white" style="background-color: #FF87CA">Lihat Detail</a>
                    </div>
